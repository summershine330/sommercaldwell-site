export default function Nav() {
  return (
    <nav className="sticky top-0 z-[100] bg-[rgba(250,247,242,0.92)] backdrop-blur-[16px] border-b border-[rgba(184,134,11,0.18)] px-5 md:px-[60px] flex items-center justify-between h-[76px]">
      ...
      <a
        href="#book"
        className="bg-navy text-white font-sans font-normal text-[0.75rem] tracking-[0.12em] uppercase px-[18px] py-[10px] md:px-[28px] md:py-[12px] no-underline transition-all duration-200 hover:bg-mid-navy hover:-translate-y-px inline-block"
      >
        Book Sommer
      </a>
    </nav>
